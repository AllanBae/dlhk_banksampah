...
<head>
    ...
    <title>Daftar Setoran | Admin Bank Sampah</title>
    ...
    <style>
        ...
        body { background-color: var(--hijau-bg); font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; overflow-x: hidden; }
        ...
        .badge-sampah { background-color: rgba(26, 143, 58, 0.1); color: var(--hijau-tua); border: 1px solid rgba(26, 143, 58, 0.3); padding: 5px 10px; border-radius: 6px; font-weight: 600; }
        @media (max-width: 768px) { #sidebar { margin-left: -260px; position: fixed; height: 100vh; } #sidebar.active { margin-left: 0; box-shadow: 5px 0 15px rgba(0,0,0,0.1); } .main-inner { padding: 15px; } }
    </style>
</head>
<body>
    ...
    <div id="content">
        <nav class="navbar top-navbar sticky-top d-flex justify-content-between align-items-center shadow-sm">
            <div class="d-flex align-items-center">
                ...
                <h4 class="fw-bold m-0 d-none d-md-block" style="color: var(--hijau-tua);">Daftar Setoran Nasabah</h4>
            </div>
        </nav>
